...
/** Adds the Rosalita climate points without replacing all vanilla Overworld biomes. */
public final class RosalitaRegion extends Region {
    public RosalitaRegion(ResourceLocation name, int weight) {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        ...
        new ParameterPointListBuilder()
            ...
            .build().forEach(point -> builder.add(point, ModBiomes.ROSALITA_BIOME));
