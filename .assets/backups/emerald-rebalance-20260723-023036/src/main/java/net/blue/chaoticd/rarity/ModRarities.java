...
public final class ModRarities {
    ...
    public static final RarityDefinition FORBIDDEN = animatedRarity(
        "forbidden",
        0xAAAAAA,
        7,
        170,
    ...
    public static final RarityDefinition LEGENDARY = RarityDefinition.builder(
            id("legendary"),
    ...
    public static final RarityDefinition EXTRAVAGANT = animatedRarity(
        "extravagant",
        0xFFD700,
        9,
        430,
    ...
    public static final RarityDefinition GOD = animatedRarity(
        "god",
        0xFFD700,
        10,
        620,
    ...
    public static final RarityDefinition ENDGAME = animatedRarity(
        "endgame",
        0xAA00FF,
        11,
        850,
    ...
    public static synchronized void bootstrap() {
        ...
        for (RarityDefinition definition : DEFINITIONS) {
        ...
        registry.registerItem(ModItems.DEATH_TOTEM, ENDGAME);

        registry.registerItem(ModItems.EMERALD_INGOT, EXTRAVAGANT);
        registry.registerItem(ModItems.DREAM_FLUID_BUCKET, GOD);
        registry.registerItem(ModItems.EMERALD_SWORD, GOD);
        registry.registerItem(ModItems.EMERALD_PICKAXE, GOD);
        registry.registerItem(ModItems.EMERALD_AXE, GOD);
        registry.registerItem(ModItems.EMERALD_SHOVEL, GOD);
        registry.registerItem(ModItems.EMERALD_HOE, GOD);
        registry.registerItem(ModItems.EMERALD_HELMET, GOD);
        registry.registerItem(ModItems.EMERALD_CHESTPLATE, GOD);
        registry.registerItem(ModItems.EMERALD_LEGGINGS, GOD);
        registry.registerItem(ModItems.EMERALD_BOOTS, GOD);

        registry.registerItemProvider(
            100,
            (context, ignored) ->
                PotionUtils.getPotion(context.stack()) == ModPotions.SAPPHIRIC
                    ? Optional.of(ULTRA_RARE)
                    : Optional.empty()
        );
        ...
        registry.registerCategoryProvider(0, (context, ignored) -> {
            ...
            if (path.contains("netherite")) {
                return Optional.of(EXTREMELY_RARE);
            }
            ...
            if (path.contains("iron") || path.contains("golden")) {
                return Optional.of(UNCOMMON);
            }
        ...
        registry.registerEnchantment(ModEnchantments.LUCK, GOD);
    ...
    public static boolean isChaoticEnchantment(Enchantment enchantment) {
        return enchantment == ModEnchantments.SAPPHIRIC
            || enchantment == ModEnchantments.DHEATHIC
            || enchantment == ModEnchantments.BIG_BERTHA
            || enchantment == ModEnchantments.ROYAL
    ...
    private static RarityDefinition staticRarity(
        ...
        return RarityDefinition.builder(
                id(path),
                "rarity.chaoticd." + path,
                color
            )
            .priority(priority)
            .progression(threshold, score)
            .fallback(COMMON_ID)
            .build();
    }
