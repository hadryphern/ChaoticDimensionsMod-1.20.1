...
public class CrystalAppleCowEntityDiesProcedure {
    public static void execute(LevelAccessor world, double x, double y, double z) {
        ItemEntity entityToSpawn;
        ServerLevel _level;
        if (world instanceof ServerLevel) {
            _level = (ServerLevel)world;
            entityToSpawn = new ItemEntity((Level)_level, x, y, z, new ItemStack((ItemLike)ChaosentitymodModItems.DIMENSION_APPLE.get()));
