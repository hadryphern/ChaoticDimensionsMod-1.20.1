...
public abstract class ArmaduraAmetistaItem
extends ArmorItem {
    public ArmaduraAmetistaItem(ArmorItem.Type type, Item.Properties properties) {
    ...
    extends ArmaduraAmetistaItem {
        public Boots() {
            super(ArmorItem.Type.BOOTS, new Item.Properties());
        }

        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "chaosentitymod:textures/models/armor/armadura_de_ametista_layer_1.png";
        }
    }
    ...
    extends ArmaduraAmetistaItem {
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "chaosentitymod:textures/models/armor/armadura_de_ametista_layer_2.png";
        }
    }
