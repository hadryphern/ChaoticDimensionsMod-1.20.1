...
public class PSSDimensionPortalDimension {

    @Mod.EventBusSubscriber(bus=Mod.EventBusSubscriber.Bus.MOD)
    public static class PSSDimensionPortalSpecialEffectsHandler {
        @SubscribeEvent
        ...
        public static void registerDimensionSpecialEffects(RegisterDimensionSpecialEffectsEvent event) {
            ...
            event.register(new ResourceLocation("chaosentitymod:pss_dimension_portal"), customEffect);
        }
    }
}
