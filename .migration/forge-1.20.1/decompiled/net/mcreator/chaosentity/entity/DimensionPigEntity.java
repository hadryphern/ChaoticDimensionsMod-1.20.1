...
import net.mcreator.chaosentity.procedures.DimensionPigEntityDiesProcedure;
...
public class DimensionPigEntity
extends Pig
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(DimensionPigEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(DimensionPigEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(DimensionPigEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    ...
    public DimensionPigEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<DimensionPigEntity>)((EntityType)ChaosentitymodModEntities.DIMENSION_PIG.get()), world);
    }

    public DimensionPigEntity(EntityType<DimensionPigEntity> type, Level world) {
        super(type, world);
        this.f_21364_ = 6;
        this.m_21557_(false);
        this.m_274367_(0.6f);
    ...
    protected void m_8097_() {
        ...
        this.f_19804_.m_135372_(TEXTURE, (Object)"dimension_pig_texture");
    }
    ...
    protected void m_7472_(DamageSource source, int looting, boolean recentlyHitIn) {
        ...
        this.m_19983_(new ItemStack((ItemLike)ChaosentitymodModItems.DIMENSION_APPLE.get()));
    }
    ...
    public void m_6667_(DamageSource source) {
        ...
        DimensionPigEntityDiesProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_());
    }
