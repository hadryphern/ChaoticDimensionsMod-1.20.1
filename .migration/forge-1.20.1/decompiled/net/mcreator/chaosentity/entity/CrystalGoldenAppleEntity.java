...
import net.mcreator.chaosentity.procedures.CrystalGoldenAppleEntityDiesProcedure;
...
public class CrystalGoldenAppleEntity
extends Cow
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(CrystalGoldenAppleEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(CrystalGoldenAppleEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(CrystalGoldenAppleEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    ...
    public CrystalGoldenAppleEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<CrystalGoldenAppleEntity>)((EntityType)ChaosentitymodModEntities.CRYSTAL_GOLDEN_APPLE.get()), world);
    }

    public CrystalGoldenAppleEntity(EntityType<CrystalGoldenAppleEntity> type, Level world) {
        super(type, world);
        this.f_21364_ = 2;
        this.m_21557_(false);
        this.m_274367_(0.6f);
    ...
    protected void m_8097_() {
        ...
        this.f_19804_.m_135372_(TEXTURE, (Object)"golden_apple_cow_texture");
    }
    ...
    public void m_6667_(DamageSource source) {
        ...
        CrystalGoldenAppleEntityDiesProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_());
    }
