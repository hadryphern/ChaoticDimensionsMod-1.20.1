...
import net.mcreator.chaosentity.procedures.GoldenAppleCowEntityDiesProcedure;
...
public class GoldenAppleCowEntity
extends Cow
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(GoldenAppleCowEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(GoldenAppleCowEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(GoldenAppleCowEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    ...
    public GoldenAppleCowEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<GoldenAppleCowEntity>)((EntityType)ChaosentitymodModEntities.GOLDEN_APPLE_COW.get()), world);
    }

    public GoldenAppleCowEntity(EntityType<GoldenAppleCowEntity> type, Level world) {
        super(type, world);
        this.f_21364_ = 6;
        this.m_21557_(false);
        this.m_274367_(1.4f);
    ...
    public void m_6667_(DamageSource source) {
        ...
        GoldenAppleCowEntityDiesProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_());
    }
