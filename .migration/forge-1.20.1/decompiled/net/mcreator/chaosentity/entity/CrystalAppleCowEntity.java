...
import net.mcreator.chaosentity.procedures.CrystalAppleCowEntityDiesProcedure;
...
public class CrystalAppleCowEntity
extends Cow
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(CrystalAppleCowEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(CrystalAppleCowEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(CrystalAppleCowEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    ...
    public CrystalAppleCowEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<CrystalAppleCowEntity>)((EntityType)ChaosentitymodModEntities.CRYSTAL_APPLE_COW.get()), world);
    }

    public CrystalAppleCowEntity(EntityType<CrystalAppleCowEntity> type, Level world) {
        super(type, world);
        this.f_21364_ = 2;
        this.m_21557_(false);
        this.m_274367_(0.6f);
    ...
    public void m_6667_(DamageSource source) {
        ...
        CrystalAppleCowEntityDiesProcedure.execute((LevelAccessor)this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_());
    }
