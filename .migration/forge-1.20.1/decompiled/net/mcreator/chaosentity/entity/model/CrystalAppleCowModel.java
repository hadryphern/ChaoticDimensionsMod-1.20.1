...
public class CrystalAppleCowModel
extends GeoModel<CrystalAppleCowEntity> {
    public ResourceLocation getAnimationResource(CrystalAppleCowEntity entity) {
        return new ResourceLocation("chaosentitymod", "animations/crystal_apple_cow.animation.json");
    }

    public ResourceLocation getModelResource(CrystalAppleCowEntity entity) {
        return new ResourceLocation("chaosentitymod", "geo/crystal_apple_cow.geo.json");
    }

    public ResourceLocation getTextureResource(CrystalAppleCowEntity entity) {
