...
public class CrystalCreeperEntity
extends Creeper
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(CrystalCreeperEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(CrystalCreeperEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(CrystalCreeperEntity.class, (EntityDataSerializer)EntityDataSerializers.f_135030_);
    ...
    public CrystalCreeperEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType<CrystalCreeperEntity>)((EntityType)ChaosentitymodModEntities.CRYSTAL_CREEPER.get()), world);
    }
    ...
    protected void m_8097_() {
        ...
        this.f_19804_.m_135372_(TEXTURE, (Object)"crystal_creeper_texture");
    }
    ...
    protected void m_7472_(DamageSource source, int looting, boolean recentlyHitIn) {
        ...
        this.m_19983_(new ItemStack((ItemLike)ChaosentitymodModItems.CRYSTAL_EYE.get()));
    }
    ...
    private PlayState movementPredicate(AnimationState event) {
        if (this.animationprocedure.equals("empty")) {
            if (event.isMoving() || !(event.getLimbSwingAmount() > -0.15f) || !(event.getLimbSwingAmount() < 0.15f)) {
                return event.setAndContinue(RawAnimation.begin().thenLoop("animation.creeper_branco.walk"));
            }
            if (this.m_21224_()) {
                return event.setAndContinue(RawAnimation.begin().thenPlay("animation.creeper_branco.death"));
            }
            return event.setAndContinue(RawAnimation.begin().thenLoop("animation.creeper_branco.idle"));
        }
